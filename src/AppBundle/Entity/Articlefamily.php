 ...
 * Articlefamily
 *
 * @ORM\Table(name="articlefamily")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ArticlefamilyRepository")
 * @Uploadable()
 */
class Articlefamily
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\CatFamily", inversedBy="articlefamilys")
     * @ORM\JoinColumn(name="catfamily_id", referencedColumnName="id")
     */
    private $catfamily;
    ...
    /**
     * @UploadableField(filename="filename", path="uploads/Family/Cover")
     ...
     * Set catbeauty
     *
     * @param \AppBundle\Entity\CatFamily $catfamily
     *
     * @return Articlefamily
     */
    public function setCatFamily(CatFamily $catfamily = null)
    {
     ...
     * Get catfamily
     *
     * @return \AppBundle\Entity\CatFamily
     */
