 ...
 * Articlemode
 *
 * @ORM\Table(name="articlemode")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ArticlemodeRepository")
 * @Uploadable()
 */
class Articlemode
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CatMode", inversedBy="articlemodes")
     * @ORM\JoinColumn(name="catmode_id", referencedColumnName="id")
     */
    private $catmode;
    ...
    /**
     * @UploadableField(filename="filename", path="uploads/Mode/Cover")
     ...
     * Set catmode
     *
     * @param CatMode $catmode
     *
     * @return Articlemode
     */
    public function setCatmode(CatMode $catmode = null)
    {
