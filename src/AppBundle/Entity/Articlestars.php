 ...
 * Articlestars
 *
 * @ORM\Table(name="articlestars")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ArticleStarsRepository")
 * @Uploadable()
 */
class Articlestars
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\CatStars", inversedBy="articlestarss")
     * @ORM\JoinColumn(name="catstars_id", referencedColumnName="id")
     */
    private $catstars;
    ...
    /**
     * @UploadableField(filename="filename", path="uploads/Stars/Cover")
     ...
     * Set catstars
     *
     * @param \AppBundle\Entity\CatStars $catstars
     *
     * @return Articlestars
     */
    public function setCatStars(CatStars $catstars = null)
    {
        $this->catstars = $catstars;
     ...
     * Get catstars
     *
     * @return \AppBundle\Entity\CatStars
     */
    public function getCatStars()
    {
        return $this->catstars;
    }
