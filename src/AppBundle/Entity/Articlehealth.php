 ...
 * Articlehealth
 *
 * @ORM\Table(name="articlehealth")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ArticlehealthRepository")
 * @Uploadable()
 */
class Articlehealth
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CatHealth", inversedBy="articlehealths")
     * @ORM\JoinColumn(name="cathealth_id", referencedColumnName="id")
     */
    private $cathealth;
    ...
    /**
     * @UploadableField(filename="filename", path="uploads/Health/Cover")
     ...
     * @return mixed
     */
    public function getCathealth()
    {
        return $this->cathealth;
    }

    /**
     * @param mixed $cathealth
     */
    public function setCathealth($cathealth)
    {
