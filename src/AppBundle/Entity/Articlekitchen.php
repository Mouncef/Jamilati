 ...
 * Articlekitchen
 *
 * @ORM\Table(name="articlekitchen")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ArticlekitchenRepository")
 * @Uploadable()
 */
class Articlekitchen
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CatKitchen", inversedBy="articlekitchens")
     * @ORM\JoinColumn(name="catkitchen_id", referencedColumnName="id")
     */
    private $catkitchen;
    ...
    /**
     * @UploadableField(filename="filename", path="uploads/Kitchen/Cover")
     ...
     * @return mixed
     */
    public function getCatkitchen()
    {
        return $this->catkitchen;
    }

    /**
     * @param mixed $catkitchen
     */
    public function setCatkitchen($catkitchen)
    {
        $this->catkitchen = $catkitchen;
    }
